    ...
    data2: [
      {
        key: '1',
        mp: '用户管理',
        children: [{ key: '1_1', mp: '用户查询' }, { key: '1_2', mp: '用户角色管理' }],
      },
      {
        key: '2',
        mp: '账户管理',
      ...
      },
      {
        key: '3',
        mp: '套餐管理',
        children: [{ key: '3_1', mp: '套餐列表' }, { key: '3_2', mp: '套餐审核' }],
      },
      {
        key: '4',
        mp: '质押管理',
        children: [{ key: '4_1', mp: '质押列表' }, { key: '4_2', mp: '质押审核' }],
      },
      {
        key: '5',
        mp: '私塾管理',
        children: [{ key: '5_1', mp: '公告、媒体新闻维护' }],
      },
      {
        key: '6',
        mp: '数据统计',
